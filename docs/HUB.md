...
| 2 | [phase-02-walker-download.md](phase-02-walker-download.md) | `pending` | BFS traversal, blob/Workspace download, manifest, progress |
| 3 | [phase-03-throttle-robustness.md](phase-03-throttle-robustness.md) | `pending` | Rate limiting, exponential backoff, retry logic |
| 4 | [phase-04-filtering.md](phase-04-filtering.md) | `pending` | API query pushdown, post-fetch filters, cost guard |
